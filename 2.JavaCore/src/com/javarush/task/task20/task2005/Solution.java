...
public class Solution {
    ...
    public static class Human {
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            String countAssets = reader.readLine();
            System.out.println(countAssets);
            if (!countAssets.equals("null")) {
                int count = Integer.parseInt(countAssets);
                for (int i = 0; i < count; i++) {
                    Asset temp = new Asset(reader.readLine());
                    temp.setPrice(Double.parseDouble(reader.readLine()));
                    this.assets.add(temp);
                }
            }
